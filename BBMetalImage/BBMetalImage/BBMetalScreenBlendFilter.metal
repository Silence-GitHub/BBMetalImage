//
//  BBMetalScreenBlendFilter.metal
//  BBMetalImage
//
...
kernel void screenBlendKernel(texture2d<half, access::write> outputTexture [[texture(0)]],
    ...
    const half4 outColor = whiteColor - ((whiteColor - textureColor2) * (whiteColor - textureColor));
