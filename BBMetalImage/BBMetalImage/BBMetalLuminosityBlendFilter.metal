//
//  BBMetalLuminosityBlendFilter.metal
//  BBMetalImage
//
...
kernel void luminosityBlendKernel(texture2d<half, access::write> outputTexture [[texture(0)]],
    ...
    const half4 outColor(base.rgb * (1.0h - overlay.a) + setlum(base.rgb, lum(overlay.rgb)) * overlay.a, base.a);
