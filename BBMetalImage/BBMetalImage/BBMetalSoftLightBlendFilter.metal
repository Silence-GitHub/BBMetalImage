//
//  BBMetalSoftLightBlendFilter.metal
//  BBMetalImage
//
...
kernel void softLightBlendKernel(texture2d<half, access::write> outputTexture [[texture(0)]],
    ...
    const half4 outColor = base * (overlay.a * (base / alphaDivisor) + (2.0h * overlay * (1.0h - (base / alphaDivisor)))) + overlay * (1.0h - base.a) + base * (1.0h - overlay.a);
