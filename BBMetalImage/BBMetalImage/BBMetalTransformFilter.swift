...
public class BBMetalTransformFilter: BBMetalBaseFilter {
    ...
    private static func matrix(from: CGAffineTransform) -> matrix_float3x2 {
        matrix_float3x2(columns: (simd_float2(x: Float(from.a ), y: Float(from.b )),
    ...
    public var transform: CGAffineTransform {
        get {
            CGAffineTransform(a:  CGFloat(_matrix[0][0]), b:  CGFloat(_matrix[0][1]),
    ...
    public init(transform: CGAffineTransform, fitSize: Bool) {
